...
yarn add yarn add git+https://github.com/wavicle-limechat/web-widget-react-native.git

# Using npm
npm install yarn add git+https://github.com/wavicle-limechat/web-widget-react-native.git
```
